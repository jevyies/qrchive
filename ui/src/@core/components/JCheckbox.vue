...
const generatedId = useId ? useId() : `j-check-${Math.random().toString(36).substring(2, 9)}`
...
const containerClasses = computed(() => {
  const classes = ['form-check', 'j-checkbox-root']
...
const inputClasses = computed(() => {
  ...
  if (sz === 'sm') classes.push('form-check-input-sm')
  else if (sz === 'lg') classes.push('form-check-input-lg')
