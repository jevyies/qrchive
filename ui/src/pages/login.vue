...
const handleManualLogin = async () => {
  if (!usernameOrEmail.value || !password.value) {
    notification.value = { type: 'danger', message: 'Please enter both your Host / Curator email and Master Key.' }
    return
  }
  ...
  try {
    ...
    notification.value = {
      type: 'danger',
      message: err.message || err.data?.message || 'Invalid credentials. Please verify your email and Master Key.',
    }
  } finally {
    isLoading.value = false
  }
    ...
    <header class="vault-header">
      <div class="header-container">
        ...
        <div class="header-actions">
          ...
          <a
            href="mailto:concierge@qrchive.com"
            class="action-link action-link--desktop"
          >
            Concierge
          </a>
      ...
      <div class="vault-card-outer">
        <div class="vault-card">
          ...
          <div class="social-grid">
            ...
            >
              <svg class="social-svg fill-current shrink-0" viewBox="0 0 24 24">
          ...
          <form class="vault-form" @submit.prevent="handleManualLogin">
            ...
            <div class="form-field">
              <label class="field-label" for="email">
                Host / Curator Email or Username
              </label>
              <div class="field-control">
                <input
                  ...
                  class="field-input"
                  placeholder="curator@atelier.com or username"
                  required
                  type="text"
            ...
            <div class="form-field">
              <div class="field-header">
                ...
                <button
                  ...
                  @click="notification = { type: 'info', message: 'To reset your Master Key, contact your vault administrator or concierge desk.' }"
                >
                  Forgot key?
                </button>
              </div>
            ...
            <div class="submit-row">
              ...
              >
                ...
                <span id="btnText" class="btn-text">
                  {{ isSuccess ? 'Vault Unlocked' : isLoading ? 'Decrypting Vault...' : 'Sign In to Vault' }}
                </span>
